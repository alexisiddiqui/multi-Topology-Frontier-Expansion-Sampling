...
def main():
    ...
    base_input_dir = os.path.join(current_dir, "RW_10/HOIP")
    base_output_dir = os.path.join(current_dir, "RW_11_FES_output/HOIP")


    residue_list =  np.load('hdx_residues/all_hdx_residues.npz')["HOIP"]
